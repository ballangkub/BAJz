...
class Segment1 {
    ...
    function __construct() {
        ...
        $file_handle = fopen(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'dictionary' .  DIRECTORY_SEPARATOR . 'dictionary1.txt', "rb");
    ...
    public function get_segment_array($input_string) {
        ...
        $this->_input_string = str_replace(array('\'', '‘', '’', '“', '”', '"', '-', '/', '(', ')', '{', '}', '...', '..', '…', '', ',', ':', '|', '\\' , 'ใน' , 'โดย' , 'ใช้' , 'การ' , 'จาก' , 'ของ' , 'และ' , 'หรือ' , 'ด้วย'), '', $this->_input_string);
